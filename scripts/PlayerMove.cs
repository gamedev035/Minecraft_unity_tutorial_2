...
public class PlayerMove : MonoBehaviour {
    ...
    [SerializeField]
    private float rotDamp = 20; // Damping value for camera rotation.
    ...
    [SerializeField]
    private float walkSpeed = 20; // Walk (normal movement) speed, set in editor.
    [SerializeField]
    private float runSpeed = 40; // Run speed, set in editor.
    [SerializeField]
    private float jumpSpeed = 40; // Jump speed, set in editor.
    ...
    private void LateUpdate()
    {
        ...
        cc.SimpleMove(moveDir * currentSpeed * Time.deltaTime);
